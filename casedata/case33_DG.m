function mpc = case33_DG
%   Power flow data for 33 bus test case with 2 Renewable Generators
%   System is a originally taken from IEEE 33 Bus system from MATPOWER
%   The file follows the MATPOWER Case Format and do conversion same as MATPOWER Case33bw
%---------------------------------------------------------------------------------------------------- 
% 
% ------------------------------------------------------------------------------------------------
%  The test file is modified to have 2 renewable generators and non-zero loads at all the PQ buses.
% DG#1 : @18 Bus P=100kW Q=50kVAr
% DG#2 : @31 Bus P=250kW Q=120kVAr
% The generators are connected as negative loads for both real and reactive power
% -----------------------------------------------------------------------------------------------
%  The test system is used in 
%  P. Pareek and H.D. Nguyen (2020)
%  " Towards Closed-Form Approximation of Inverse Power Flow via Gaussian Process Learning "
%  Preprint available at : 
%
%	This testbed is alloed to be distributed and use for reserach purpose, but without any warranty.
...
mpc.bus = [  %% (Pd and Qd are specified in kW & kVAr here, converted to MW & MVAr below)
	...
	18	1	90-100	40-50	0	0	1	1	0	12.66	1	1.1	0.9; % DG#1
	...
	31	1	150-250	70-120	0	0	1	1	0	12.66	1	1.1	0.9; %DG#2
